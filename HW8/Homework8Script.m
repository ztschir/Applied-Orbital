...
% Now take into account the earths oblateness and modify the latitude

f = 0.000335;
latitude = atand(((1-f)^2)*tand(latitude))
...
trueAnomaly2 = asind(Rperifocal(2)*mu/angularMomentum^2)
trueAnomaly3 = atand(Rperifocal(2)/Rperifocal(1)) + 360
